      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pb-8 border-b border-gray-700">
          ...
          <div className="md:col-span-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-2xl font-bold">Denis Gorshkov</span>
            </div>
            <p className="text-gray-400 mb-6 leading-relaxed">
              Web developer and designer specializing in creating beautiful, functional websites
              and digital experiences that help businesses achieve their goals.
            </p>
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-2">
              <li><span className="text-gray-400">Moscow, Russia</span></li>
              <li><span className="text-gray-400">contact@dengor.ru</span></li>
              <li><span className="text-gray-400">+7 (999) 123-4567</span></li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © {currentYear} Denis Gorshkov. All rights reserved.
          </p>
